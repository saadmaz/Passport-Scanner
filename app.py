...
# Absolute directory of this script — safe regardless of where Flask is launched from
...
def process_passport_image(image_path):
    try:
        ...
        temp_processed_path = os.path.join(BASE_DIR, "temp_processing.jpg")
...
def scan_endpoint():
    ...
    temporary_save_path = os.path.join(BASE_DIR, "active_upload.jpg")
